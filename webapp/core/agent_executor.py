...
def _get_output_instructions(step_id: str) -> str:
    instructions = {
        "step-01": (
            ...
            "- Notícias sobre resultados financeiros, faturamento, lucros, earnings ou balanço de empresas\n"
            "- Notícias puramente de negócios sem relação com saúde, wellness ou inovação em saúde\n"
            "- Notícias políticas ou econômicas gerais (eleição, dólar, governo, presidente)\n"
            "- Conteúdo opinativo, colunas, cartas, reflexões pessoais ('Carta para meu filho', 'Por que X é importante')\n"
            "- Listas genéricas de dicas de saúde ('5 hábitos', '3 alimentos', 'como fazer X')\n"
            "- Perguntas retóricas sem notícia concreta ('Por que não há eclipses todo mês?')\n"
            "- Artigos de lifestyle sem relevância para saúde/inovação (casamento, comida, viagem, moda)\n"
            "PRIORIZAR:\n"
            "- Lançamentos, descobertas e aprovações (produto novo, estudo publicado, aprovação Anvisa/FDA)\n"
            "- Alertas de saúde pública (contaminação, surto, risco)\n"
            "- IA e tecnologia aplicadas à saúde (diagnóstico, wearables, apps, robótica)\n"
            "- Tendências com dados concretos (pesquisa, percentual, número de pessoas afetadas)\n\n"
